...
# read L88_57 data and add one row of plant environment well-water(ww) and water-stress(ws)
...
# note the biomass data also consist of other genotypes biomass, we are going to match that with L88_57 and rm NAs 
...
# I notice there are duplicates for the experiment_tag and root images, which is not expected. 
...
# go back to images we took for roots, they have labels in the image, so we check it if people mistakely input the tag or computer mistakely extract the wrong tag
...
L88_57_fixed <- biomass_merge[!(biomass_merge$Image.name %in% c("DSC_9346.JPG","DSC_9345.JPG", "DSC_9641.JPG", "DSC_9682.JPG", "DSC_9729.JPG","DSC_9670.JPG","DSC_0882.JPG",
                                                               "DSC_0502.JPG","DSC_0099.JPG","DSC_9669.JPG","DSC_9671.JPG","DSC_9651.JPG")),]
...
# transfer the categorial data to numerical data 
#levels(L88_57_fixed$environment) = c("ww","ws")
#L88_57_fixed$environment <- factor(L88_57_fixed$environment)
summary(L88_57_fixed)
