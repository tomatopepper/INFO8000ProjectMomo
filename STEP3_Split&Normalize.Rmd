---
title: "STEP3_Split&Normalize_Data"
author: "Limeng Xie"
date: "5/8/2019"
...
and divide them into training dataset and testing dataset at a ratio of 8:2
```{r}
library(caret)
...
The normalized data are uniformly distributed.